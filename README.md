...
* **VCF Authentication Automation:** Uses an `expect` script to securely and invisibly bypass the interactive prompts in the `vcf context create` CLI command.
...
Open a standard terminal on your clean Ubuntu desktop and paste the following one-liner. It will pass your lab password automatically, clone the repositories, and kick off the entire process.
